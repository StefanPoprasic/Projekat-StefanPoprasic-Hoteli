<%-- 
    Document   : Menadzer2
    Created on : Feb 3, 2019, 8:06:36 PM
    Author     : Poprasic
--%>
            ...
            <table>
                ...
                <c:forEach items="${sobe}" var="soba">
                    <tr>
                        ...
                        <td>${soba.ime}</td>
                        <td>${soba.cena}</td>
                        <td><a href="BrisanjeSobe2?idSoba=${soba.idSoba}">Obrisi</a></td>
                    </tr>
                </c:forEach>
             </table>
              <form action="DodajSobu2" method="post">
                <table>
             ...
             <form action="IzmeniSobu2" method="post">
                <table>
                    <h4>Izmeni sobu</h4>
                     <tr>
             ...
             <form action="IzmeniHotel2" method="post">
                <table>
