 ...
 * @author Poprasic
 */
public class IzborSobe extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet IzborSobe</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet IzborSobe at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
   ...
   String idHotel=(String)request.getParameter("idHotel");
        ...
        try{
            ...
            String upit="select idSoba,tipSobe,cena,idHotel from soba where idHotel='"+idHotel+"'";
          ResultSet rs=stmt.executeQuery(upit);
            ...
            request.getRequestDispatcher("IzborSobe.jsp").forward(request, response);
        }
