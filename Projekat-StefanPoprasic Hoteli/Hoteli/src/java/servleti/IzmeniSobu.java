...
public class IzmeniSobu extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet IzmeniSobu</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet IzmeniSobu at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(idHotel!=null && idHotel.length()>0 && tipSobe!=null && tipSobe.length()>0
            ...
            try{
                ...
                st.executeUpdate("update soba set idSoba='"+idSoba+"',tipSobe='"+tipSobe+"',cena='"+cena+"',idHotel='"+idHotel+"'where idSoba='"+idSoba+"'");
                st.close();
                con.close();
