...
public class Sobe extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Sobe</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Sobe at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            String upit="select soba.idSoba,soba.tipSobe,soba.cena,soba.idHotel,hotel.ime from Soba inner join hotel where soba.idHotel=hotel.idHotel ";
          ResultSet rs=stmt.executeQuery(upit);
            ...
            request.getRequestDispatcher("IzmenaSoba.jsp").forward(request, response);
        }
