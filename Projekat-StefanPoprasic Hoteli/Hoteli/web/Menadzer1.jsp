<%-- 
    Document   : Menadzer1
    Created on : Jan 17, 2019, 2:21:18 PM
    Author     : Poprasic
--%>
            ...
            <table>
                ...
                <c:forEach items="${sobe}" var="soba">
                    <tr>
                        ...
                        <td>${soba.ime}</td>
                        <td>${soba.cena}</td>
                        <td><a href="BrisanjeSobe1?idSoba=${soba.idSoba}">Obrisi</a></td>
                    </tr>
                </c:forEach>
             </table>
              <form action="DodajSobu1" method="post">
                <table>
             ...
             <form action="IzmeniSobu1" method="post">
                <table>
                    <h4>Izmeni sobu</h4>
                     <tr>
             ...
             <form action="IzmeniHotel1" method="post">
                <table>
                    <h4>Izmeni naziv hotela</h4>
                     <tr>
                    <td width="50px">Ime hotela</td>
                    
                    
                </tr>
                    <tr>
                        <td><input size="20" type="text" name="ime"></td>
                        
                        <td><input size=50 type="submit" value="Izmeni"></td>
                    </tr>                                        
                </table>
            </form>
